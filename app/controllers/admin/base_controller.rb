...
class Admin::BaseController < ApplicationController
  # Skip Pundit's verify_authorized so mounted engines (Mission Control Jobs) that inherit
  # this base controller don't explode. Our own admin controllers still call authorize explicitly.
  skip_pundit
  ...
  private
    ...
    def require_admin
      ...
      respond_to do |format|
        format.html { redirect_to main_app.root_path, alert: "You do not have access to that page." }
