...
Plans:
- [ ] 05-01: Build symptom timeline index view — paginated, reverse-chronological
- [ ] 05-02: Add date range filter to timeline (Turbo Frame or standard form)
- [ ] 05-03: Build severity trend summary — counts by severity over filtered range
- [ ] 05-04: Add database index on user_id + recorded_at for query performance
- [ ] 05-05: Write Minitest coverage for timeline display, filtering, and trend calculation
